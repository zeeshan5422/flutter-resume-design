  ...
  static ResumeContent mContent = ResumeContent(
    ...
    contentExperience: [
      ...
      ContentExperience(
          ...
          description:
              "that include UI components, network layer wrapper on Retrofit, database layer wrapper on Room,"
    ...
    communityWork: [
      ...
      ContentExperience(
        title: "Android Spinner Library",
        description:
            "Searchable-Spinner-Kotlin is a simple spinner, which support searching items, click events, sorting and some other features.",
        link: "https://github.com/zeeshan5422/flutter-resume-design",
      ),
    ],
  );
